...
%% Last update jeu. 02 sept. 2010 22:40:20 CEST Philippe THIERRY
%%
...
\begin{lstlisting}[name=Extrait de la table des symboles de la glibc, label=libc_symb]
...
Format}. L'image \ref{fig:elf} décrit la structure du binaire et ses différentes sections.
...
\paragraph{}
Enfin, il est important de noté que de nouvelles options de compilation apparaîssent au fur et à mesure des nouvelles
