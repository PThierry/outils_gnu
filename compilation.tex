...
%% Last update sam. 18 sept. 2010 11:36:07 CEST Philippe THIERRY
%%
...
\paragraph{}
Les sections qui ne figurent pas dans un binaire sont les sections {\it dynamiques}. Il s'agit du tas (heap) et de
la pile (stack). En effet, ces sections n'ont de sens que durant l'exécution du binaire, car sont
construites au travers   de   l'exécution   du   code.    Ces   sections   sont   le   propre    d'un    processus.
