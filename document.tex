...
%% Last update lun. 06 sept. 2010 20:14:30 CEST Philippe THIERRY
%%
...
\input{structure_des_sources.tex}
\input{compilation.tex}
\input{makefiles.tex}
\input{les_outils_de_conf.tex}
\input{tests_profiling.tex}

\begin{appendices}
\input{cpp_result.tex}
\end{appendices}
