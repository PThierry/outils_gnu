...
%% Last update Thu Sep  9 15:14:26 2010 Philippe THIERRY
%%
...
compilation. Ces dernières sont celles utilisées par les outils de configuration des sources. Sont
...
chaîne de compilation les reconnais.\\
Cependant, en faisant ainsi, on se heurte parfois à des problèmes de portabilité. En effet, il
arrive fréquement que le projet soit compilé avec une chaîne de compilation dont on ne maîtrise pas
les versions du compilateurs ou encore du linker. Ainsi, selon la version utilisée, les options de
compilation définies dans le Makefiles peuvent ne pas être reconnues, et provoquer un arrêt de la
construction du projet.\\
Il en vas de même pour la vérification de la présence des divers binaires nécessaires à la
...
Les autotools étant le plus fréquement utilisés (ils sont à l'origine de la commande {\tt
