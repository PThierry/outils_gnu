...
%% Last update Fri Sep  3 15:15:43 2010 Philippe THIERRY
%%
...
Ces éléments de durcissement du logiciel implémentés sont très important dans les domaines de
...
{\texttt gprof}\index{Gprof} qui à  l'instar de {\texttt gcov} va permettre  après un post traitement de
fournir des graphes permettant d'analyser le bon comportement .

FIXME Phil, mettre un exemple ici issu de libcommon avec explication
...
du nom de  Mr Mac Cabe, universitaire dans  les années 80.\\

FIXME: ( Phil merci de vérifier!).
...
\paragraph{}
Tous ces outils contribuent un métier : le génie logiciel
