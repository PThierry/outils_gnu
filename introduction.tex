...
\paragraph{}
Le but de ce document est de fournir une base de connaissance suffisante permettant d'apréhender l'architecture des
éléments logiciels utilisés dans les environnements UNIX/Linux.

\paragraph{}
Le nombre de logiciels s'appuyant sur le système de production décrit ci-après est très important, et l'est de plus
en plus avec l'arrivée des nouvelles plateformes logicielles embarquées dans la téléphonie ou encore la télévision,
...
appliances\footnote{Solutions complètes pour répondre à un besoin, associant logiciels et matériels} (hors CISCO IOS).

\paragraph{}
Dans le métier des télécommunications ou encore chez les industriels de la téléphonie ou les fournisseurs de
logiciels embarqués, les projets se basent de plus en plus fréquemment sur le système de production standardisé par
UNIX, sous sa version libre GNU (Gnu Compiler Collection). Ce document en décrit les arcanes et met en lumière
